...
There are two complete programs in the collection, `bestwayhome`, which runs the travelling salesman problem, and `roman`, which translates roman numerals into decimal.
